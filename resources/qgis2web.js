...
map.getView().fit([12270405.196516, -879539.314214, 12303248.041663, -860741.063965], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Klasifikasi Kepadatan Penduduk Kota Yogyakarta</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (229 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'peta ini memberikan informasi jumlah penduduk, kepadatan penduduk, san luas wilayah di Kota Yogyakarta, Sumber data yang diperoleh dari kota yogyakarta dalam angka yang diterbitkan badan pusat statistikYogyakarta pada tahun 2024.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_KepadatanPedudukKotaYogyakarta_1,
    colName: 'join_Kepad',
    zoom: 10,
    collapsed: true,
    map: map,

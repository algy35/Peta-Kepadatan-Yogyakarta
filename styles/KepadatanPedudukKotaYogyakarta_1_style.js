...
var style_KepadatanPedudukKotaYogyakarta_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 8.225035 && value <= 12.025243) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.025243 && value <= 13.908058) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.908058 && value <= 18.358120) {
            style = [ new ol.style.Style({
